    ...
    return product && (
        <div
            ...
            <div className="text-gray-500/60 text-sm space-y-1 md:space-y-1.5">
                ...
                <div className="flex flex-wrap items-end justify-between mt-2 md:mt-3">
                    ...
                    <div className="text-primary cart-controls ml-auto">
                        {!cartItems[product._id] ? (
                            <button
                                className="flex items-center justify-center gap-1 bg-primary/10 border border-primary/40 md:w-[80px] w-[64px] h-[34px] rounded cursor-pointer hover:bg-primary/20 transition-colors duration-200"
                                onClick={(e) => {
                                    e.stopPropagation();
